describe("Pairwise helper", () => {
  ...
  beforeEach(() => {
    pairwise = require("./gcalendar.util").pairwise;
  });
...
describe("busyToFree helper", () => {
  ...
  beforeEach(() => {
    busyToFree = require("./gcalendar.util").busyToFree;
  });
...
describe("freeAroundEvent", () => {
  ...
  beforeEach(() => {
    freeAroundEvent = require("./gcalendar.util").freeAroundEvent;
...
describe("calculateTimeUntilEvent", () => {
  ...
  beforeEach(() => {
    calculateTimeUntilEvent = require("./gcalendar.util").calculateTimeUntilEvent;
    moment = require("moment");
  });
