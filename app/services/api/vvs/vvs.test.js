...
describe("VVS Service: getStopByKeyword(...)", () => {
  ...
  test("getStopByKeyword(...) resolves promise", () => {
    const mockRes = require("../../../../test/__fixtures__/vvs/getStopByKeywordResponse");
  ...
  test("getStopByKeyword(...) rejects error due to unresolvable keyword", () => {
    const mockRes = require("../../../../test/__fixtures__/vvs/getStopByKeywordUnresolvableReject");
    axios.get.mockResolvedValue({ data: mockRes });
  ...
  test("getStopByKeyword(...) rejects error due to ambivalent keyword", () => {
    const mockRes = require("../../../../test/__fixtures__/vvs/getStopByKeywordAmbivalentReject");
    axios.get.mockResolvedValue({ data: mockRes });
...
describe("VVS Service: getStopByKeyword(...)", () => {
  ...
  test("getTrip(...) resolves promise", () => {
    const mockRes = require("../../../../test/__fixtures__/vvs/getTripResolve");
    axios.get.mockResolvedValue({ data: mockRes });
  ...
  test("getTrip(...) rejects error due to invalid query parameters", () => {
    const mockRes = require("../../../../test/__fixtures__/vvs/getTripInvalidParametersReject");
    axios.get.mockResolvedValue({ data: mockRes });
