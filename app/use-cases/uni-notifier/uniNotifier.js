const watsonSpeech = require("../../modules/watson-speech/watsonSpeech")(); // voice I/O handling
...
module.exports = (preferences, oAuth2Client) => {
  const vvs = require("../../services/api/vvs/vvs.js")();
  const maps = require("../../services/api/gmaps/gmaps.js");
  const cal = require("../../services/api/gcalendar/gcalendar.js")(preferences, oAuth2Client);
