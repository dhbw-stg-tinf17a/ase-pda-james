...
describe("setAbsentTimes", () => {
  ...
  const onlyStartTime = require("../../../test/__fixtures__/sendAbsentHelpers/onlyStartTime");
  ...
  beforeEach(() => {
    ...
    jest.doMock("../../modules/watson-assistant/watsonAssistant", () => {
      return function () {
        return {
    ...
    setAbsentTimes = require("./sendAbsent.util").setAbsentTimes;
  });
...
describe("createEmailOptions", () => {
  ...
  beforeEach(() => {
    ...
    createEmailOptions = require("./sendAbsent.util").createEmailOptions;
  });
...
describe("createEmailText", () => {
  ...
  beforeEach(() => {
    ...
    getFunction = jest.fn();
    preferences = { get: getFunction };
    createEmailText = require("./sendAbsent.util").createEmailText;
  });
